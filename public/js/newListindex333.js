!function (t, e) {
    ...
    return function (t) {
        ...
        e.default = {
            ...
            name: "maliangeditor",
            label: "imagelist",
            style: {width: "960px", height: "260px"},
            stack: !1,
            childLimit: 9999,
            leaf: !1,
            props: {
                ...
                isshow: {type: Boolean, default: true, editor: {label: "是否隐藏文字", type: "isshow"}},
                spacew: {type: String, default: "150", editor: {label: "宽", type: "text"}},
                spaceh: {type: String, default: "230", editor: {label: "高", type: "text"}},
                fontsize: {type: Number, default: 16, editor: {label: "字体大小", type: "number"}},
                leftw: {type: String, default: "10", editor: {label: "元素左侧增加距离", type: "text"}},
                bottomw: {type: String, default: "10", editor: {label: "元素下方增加距离", type: "text"}},
                imglist: {
        ...
        t.exports = function (t, e, n, v, h, m, y) {
            ...
            var g, b, _, x = function (t) {
                ...
                }, S = e + " Iterator", w = "values" == h, j = !1, O = t.prototype,
                P = O[l] || O["@@iterator"] || h && O[h], M = P || x(h), C = h ? w ? x("entries") : M : void 0,
                T = "Array" == e ? O.entries || P : P;
            if (T && (_ = f(T.call(new t))) !== Object.prototype && _.next && (a(_, S, !0), r || "function" == typeof _[l] || u(_, l, d)), w && P && "values" !== P.name && (j = !0, M = function () {
                return P.call(this)
            }), r && !y || !p && !j && O[l] || u(O, l, M), s[e] = M, s[S] = d, h) if (g = {
                values: w ? M : x("values"),
                keys: m ? M : x("keys"),
                entries: C
        ...
        var s = n(90), c = n(25), a = r, f = Object(c.a)(i.a, s.a, s.b, !1, a, "data-v-a4b28daa", null);
        e.default = f.exports
    }, function (t, e, n) {
        var r = n(45);
        ...
        e = t.exports = n(14)(!1), e.push([t.i, ".component[data-v-a4b28daa]{width:100%;height:100%}.imglist[data-v-a4b28daa]{width:500px;height:500px;position:relative;white-space:nowrap}.imglist-item[data-v-a4b28daa]{width:150px;height:230px;position:absolute;top:15px;left:15px}.imglist-item-img[data-v-a4b28daa]{width:150px;height:230px}.imglist-item-title[data-v-a4b28daa]{height:30px;line-height:30px;background:#000;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;position:absolute;bottom:0;left:0;right:0}", ""])
    }, function (t, e, n) {
        "use strict";
        e.__esModule = !0;
        ...
        var r, o, i, u, s = n(19), c = n(0), a = n(9), f = n(35), l = n(8), p = n(5), d = n(10), v = n(70), h = n(71),
            m = n(36), y = n(37).set, g = n(76)(), b = n(24), _ = n(38), x = n(77), S = n(39), w = c.TypeError,
            j = c.process, O = j && j.versions, P = O && O.v8 || "", M = c.Promise, C = "process" == f(j),
            T = function () {
            }, E = o = b.f, L = !!function () {
                try {
                ...
                if (!t._n) {
                    ...
                    g(function () {
                        for (var r = t._v, o = 1 == t._s, i = 0; n.length > i;) !function (e) {
                            ...
                            try {
                                s ? (o || (2 == t._h && N(t), t._h = 1), !0 === s ? n = r : (f && f.enter(), n = s(r), f && (f.exit(), u = !0)), n === e.promise ? a(w("Promise-chain cycle")) : (i = I(n)) ? i.call(n, c, a) : c(n)) : a(r)
                            } catch (t) {
                                f && !u && f.exit(), a(t)
                            }
                        }(n[i++]);
                ...
                y.call(c, function () {
                    ...
                    if (i && (e = _(function () {
                        C ? j.emit("unhandledRejection", o, t) : (n = c.onunhandledrejection) ? n({
                            promise: t,
                            reason: o
                ...
                y.call(c, function () {
                    var e;
                    C ? j.emit("rejectionHandled", t) : (e = c.onrejectionhandled) && e({promise: t, reason: t._v})
                })
            }, z = function (t) {
                var e = this;
        ...
        L || (M = function (t) {
        ...
        }), l(l.G + l.W + l.F * !L, {Promise: M}), n(23)(M, "Promise"), n(79)("Promise"), u = n(2).Promise, l(l.S + l.F * !L, "Promise", {
            reject: function (t) {
                var e = E(this);
            ...
            resolve: function (t) {
                return S(s && this === u ? M : this, t)
            }
        }), l(l.S + l.F * !(L && n(80)(function (t) {
            M.all(t).catch(T)
        })), "Promise", {
            all: function (t) {
        ...
        var r = function () {
            ...
            return n("div", {staticClass: "component"}, [n("div", {staticClass: "imglist"}, t._l(t.imglist, function (e, r) {
                return n("div", {
                    key: r,
                    staticClass: "imglist-item",
                    style: "width:" + parseInt(t.spacew) + "px;height:" + parseInt(t.spaceh) + "px;left:" + parseInt(r * parseInt(t.spacew) + r * parseInt(t.leftw)) + "px;bottom:" + parseInt(r * parseInt(t.spaceh) + r * parseInt(t.bottomw)) + "px;font-size:" + t.fontsize + "px"
                }, [n("img", {
                    staticClass: "imglist-item-img",
                    style: "width:" + parseInt(t.spacew) + "px;height:" + parseInt(t.spaceh) + "px;",
                    attrs: {src: e.imgurl, alt: ""}
                }), t._v(" "), t.isshow ? n("div", {staticClass: "imglist-item-title"}, [t._v(t._s(e.label))]) : t._e()])
            }), 0)])
        }, o = []
    }])
});