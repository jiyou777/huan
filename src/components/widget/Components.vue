...
<script type="text/ecmascript-6">
  ...
  import datalist from '../../assets/layout/commponent.json'
  export default {
    ...
    methods: {
      imgError (ev = {}) {
        ...
        const src = target.src
          console.log(/cover.png$/.test(src))
      ...
      search () {
        ...
        this.comLists = datalist.data && datalist.data.list || []
        // Server({
        //   url: '../../layput/commponent.json',
        //   method: 'get', // default
        //   needLoading: false,
        //   data: {
