      ...
      <el-card shadow="hover" class="itemWarp" v-for="(item,index) in list" :key="index">
        <div class="n1">
          <div class="img">
            <img
              v-if="item.icon"
              :src="item.icon+'?x-oss-process=image/resize,w_120/crop,w_120,h_120'"
            />
        ...
        <div class="n2">
          <img
            v-if="item.icon"
            class="img"
            :src="item.icon+'?x-oss-process=image/resize,w_300/crop,w_300,h_300'"
          />
          <div class="mask"></div>
...
export default {
  ...
  methods: {
          ...
          list: [
            {
              ...
              userId: 9235,
              icon:
                "https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/resource/ymm1591324061381.png",
              desc: "12",
              id: 2485,
              name: "12",
              content:
                '{"id":"truck/button38","type":"truck/button","label":"按钮38","version":"0.1.6","url":"https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/truck/button/0.1.6/index.js","visible":true,"style":{"background-color":"","color":"","width":null,"height":null},"animate":[],"props":{"text":"输入文121211字","type":"default","click":[]},"path":"https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/truck/button/0.1.6/index.js","script":"","forceStyle":{"left":"50px","top":"20px"},"events":[],"stack":true,"childLimit":9999,"leaf":false,"packed":true}',
              categoryId: 2,
              createTime: "2020-06-05T02:27:44.000Z",
              updateTime: "2020-06-05T06:44:38.000Z"
            }
          ]
        }
      };
    ...
    install: function(item) {
      ...
      if (!window.$vue)
        return this.$alert("请先选中页面内的组件，再为其添加子组件");
