...
//   import CodeEditor from '../code/index'
  ...
  export default {
    ...
    components: {EditorBase, EditorFlutter, EditorLayout, EditorSize, EditorPosition, EditorBorder, EditorRadius, EditorText, EditorBackground, Align},
    props: {
      info: {
        required: true,
        type: Object
