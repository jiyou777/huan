<template>
  <el-dialog class="preview-app" :title="title" width="1280px" :modal="true" :visible.sync="Visible" @close="close">
    <div class="phone-box">
      <iframe ref="previewframe" class='iframe' border="0" src="http://localhost:8565/html"></iframe>
